...
namespace Quiz.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return PartialView(db.Groups.Where(c => c.UniversityId == id).ToList());
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                UserProfile userAdditionalInfo = new UserProfile();
                userAdditionalInfo.Id = user.Id;
                userAdditionalInfo.Surname = model.Surname;
                userAdditionalInfo.Name = model.Name;
                userAdditionalInfo.GroupId = model.Group;
                userAdditionalInfo.Group = db.Groups.Find(model.Group);
                userAdditionalInfo.Rating = 5;

                db.UserProfiles.Add(userAdditionalInfo);
                db.SaveChanges();
